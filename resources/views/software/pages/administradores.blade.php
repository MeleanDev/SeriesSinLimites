                ...
                <form id="formulario" enctype="multipart/form-data">
                    ...
                    <div class="modal-body text-center">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="rolinput" readonly class="form-control">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" autocomplete="false" required minlength="1" maxlength="255"
                                class="form-control" id="email" placeholder="Email">
                        </div>
                        <div class="form-group">
                            <label for="password" id="titlepassword">Password</label>
                            <input type="password" autocomplete="false" required minlength="8" maxlength="255"
...
@push('js')
    <script src="{{ asset('jsModulo/administrador.js') }}"></script>
    <script>
                ...
                },
                {
                    ...
                    "render": function(row, data) {
                        if (row.email == '{{ Auth::user()->email }}') {
                            return `<span class="badge badge-danger">Tu</span>`
                        } else {
                            return `
