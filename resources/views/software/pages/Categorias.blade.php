                    ...
                    <div class="modal-body text-center">
                        <div class="form-group">
                            ...
                            <input type="text" autocomplete="false" required minlength="1" maxlength="255" class="form-control"
                                id="nombre" placeholder="Gaseosas">
                                <small id="nombreHelp" class="form-text text-muted">Nombre de la Categorias (Obligatorio).</small>
                        </div>
                        <div class="form-group">
                            <label for="descripcion">Descripcion *</label>
                            <input type="text" autocomplete="false" required minlength="1" maxlength="255" class="form-control"
                                id="descripcion" placeholder="Es un ....">
                                <small id="descripcionHelp" class="form-text text-muted">Descripcion corta de la Categorias (Obligatorio).</small>
                        </div>
                    </div>
